...
var googleFormsCSS = function(params) {
  ...
  // request
  jQuery.get('/assets/google-forms-css/google-forms-css-cors.php?url=' + formURL, function(data) {
    ...
    items.forEach(function(item, index) {
      ...
      if (title || description) {
        ...
        if (title) {
          ...
          titleEl.text(title);
          if (required) {
            titleEl.append(' <span class="text-success">*</span>');
          }
    ...
    jQuery('#google-forms-css-form').append('<div class="form-group"><button class="btn btn-lg btn-success" type="submit">Submit</button></group>');
